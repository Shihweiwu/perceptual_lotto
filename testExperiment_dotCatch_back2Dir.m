function myscreen = testExperiment_dotCatch_back2Dir(screenName)
%
% Modified from testExperiment_dotCatch_limitLife_2p2. dot-catching task.
% > Back to direction task. Dots not moving out to a single exit
%
...
% task{2}{1}.parameter.keppa = [1]; %dispersion parameter. greater value means smaller SD.
...
task{2}{1}.parameter.coherence = [0.1 0.2 0.4];
