function [ myscreen ] = afcom_wei( varargin )
...
%   either cue one side of the screen or one feature (color or direction?), and then post-cue to
...
%
%   ==== Shih-Wei
%   1. A cue -- pay attention to left/right or pay attention to
%   motion/color.
%   2. subjects see dots stimuli
%   3. a cue -- Given previous cue (e.g. left), pay attention to motion
%   4. Subjects respond by turning a knob (e.g. motion direction)
%   Why need two pairs? One pair should be enough for this task.
%   ==== 
%
...
% dots is a struct array defined above. Here fields below in dots are
% redefined.
...
dots.dotScale = 3;
dots.maxAlive = 1000;
stimulus.cueDots = initDots(dots); %initialize dots according to the specifications above.
